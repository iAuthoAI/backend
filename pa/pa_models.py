from sqlalchemy import Column, String, Boolean, DateTime, ForeignKey, Date, ARRAY, Enum as SAEnum, Text, Integer, SmallInteger, Numeric
...
class PaRequest(Base):
    ...
    payer = relationship("Payer")
    requesting_provider = relationship("User")
