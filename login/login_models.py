...
class Organization(Base):
    ...
    # patients = relationship("Patient", back_populates="organization") # Decoupled for microservices
...
class User(Base):
    ...
    # pa_requests = relationship("PaRequest", ...) # Decoupled
    # notifications = relationship("Notification", ...) # Decoupled
