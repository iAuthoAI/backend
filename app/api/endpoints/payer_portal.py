...
from app.models.pa_request import PaRequest, PaStatusHistory
from app.models.patient import Patient, PatientCoverage
from app.models.payer import Payer, PayerPolicy
...
@router.get("/intake/review/{pa_id}")
...
@router.post("/intake/review/{pa_id}")
...
@router.post("/clinical/review/{pa_id}")
...
@router.get("/decision/review/{pa_id}")
...
@router.post("/decision/review/{pa_id}")
